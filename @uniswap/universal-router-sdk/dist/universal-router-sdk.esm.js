...
var UNIVERSAL_ROUTER_ADDRESS = function UNIVERSAL_ROUTER_ADDRESS(chainId) {
	switch (chainId) {
	  // Story Iliad Testnet
	  case 1513:
		return '0x47a7674fd3a691d8a704dFa906beCcB5f067c416';
	  default:
...
var WETH_ADDRESS = function WETH_ADDRESS(chainId) {
	switch (chainId) {
	  // Story Iliad Testnet
	  case 1513:
		return '0xDD897102DaE82230C3C8588addEc7355F13D0c7f';
	  default:
		throw new Error("WETH9 or UniversalRouter not deployed on chain " + chainId);
	}
};
var PERMIT2_ADDRESS = '0xD150Ae8b63acb433885BaCa7E79418bFb82A2aaf';

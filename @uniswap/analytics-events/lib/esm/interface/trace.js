...
(function (InterfaceModalName) {
    ...
    InterfaceModalName["EXTENSION_LAUNCH_PROMOTIONAL_MODAL"] = "extension-launch-promotional-modal";
    InterfaceModalName["GETTING_STARTED_MODAL"] = "getting-started-modal";
...
(function (InterfaceElementName) {
    ...
    InterfaceElementName["CLOSE_BUTTON"] = "close-button";
    ...
    InterfaceElementName["DOWNLOAD_BUTTON"] = "download-button";
    ...
    InterfaceElementName["EXTENSION_DOWNLOAD_BUTTON"] = "extension-download-button";
    InterfaceElementName["EXTENSION_DOWNLOAD_CONNECTOR"] = "extension-download-connector";
    ...
    InterfaceElementName["POOLS_TABLE_ROW"] = "pools-table-row";
    InterfaceElementName["PRICE_UPDATE_ACCEPT_BUTTON"] = "price-update-accept-button";
    InterfaceElementName["SEND_BUTTON"] = "send-button";
    InterfaceElementName["SEND_FIAT_TOGGLE"] = "send-fiat-toggle";
    InterfaceElementName["SEND_MAX_BUTTON"] = "send-max-button";
    InterfaceElementName["SEND_REVIEW_BUTTON"] = "send-review-button";
    InterfaceElementName["SETTINGS_CURRENCY_OPTION"] = "settings-currency-option";
    InterfaceElementName["SETTINGS_LANGUAGE_OPTION"] = "settings-language-option";
    ...
    InterfaceElementName["TOKENS_TABLE_ROW"] = "tokens-table-row";
    ...
    InterfaceElementName["UNISWAP_WALLET_LANDING_PAGE_DOWNLOAD_BUTTON"] = "uniswap-wallet-landing-page-download-button";
    InterfaceElementName["UNISWAP_WALLET_MODAL_DOWNLOAD_BUTTON"] = "uniswap-wallet-modal-download-button";
    InterfaceElementName["UNISWAP_WALLET_NAVBAR_MENU_DOWNLOAD_BUTTON"] = "uniswap-wallet-navbar-menu-download-button";
